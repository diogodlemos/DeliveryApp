...
function SellerOrderProduct({ product, index }) {
  return (
    <div className="checkout-product">
      <div style={ { display: 'flex', width: '100%', height: '100%' } }>
        ...
        <p
          ...
          data-testid={ `seller_order_details__element-order-table-name-${index - 1}` }
        >
          {product.name}
        </p>
      </div>
...
export default SellerOrderProduct;

SellerOrderProduct.propTypes = {
